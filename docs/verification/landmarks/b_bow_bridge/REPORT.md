...
Script: `blender/landmarks/b_bow_bridge.py` · agent B · generated 2026-09-06 13:18 UTC
...
the real OSM way ``580516390`` (``man_made=bridge``, name Bow Bridge, 27 x 41 m), NYC_TM centroid
...
the cast-iron balustrade's decorative pattern, the urn castings, the timber deck planking pattern, the
