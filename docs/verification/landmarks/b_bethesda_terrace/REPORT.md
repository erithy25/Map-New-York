...
Script: `blender/landmarks/b_bethesda_terrace.py` · agent B · generated 2026-09-07 00:55 UTC
...
the terrace's real OTI footprints, BINs **1090516** (1,795 m2) and **1091041** (1,583 m2), both named
...
Mould's carved panels on the staircase piers and balustrades (the seasons, day and night, birds and
