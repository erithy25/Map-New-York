...
* The landmark models carry real fenestration where the tile shells do not: the glazed towers at the right of the frame and the tapered tower closing the canyon have window grids, mullion lines and reflective glass, and they read as buildings rather than as extruded card. The contrast with the flat shells beside them is the clearest statement in the set of what a facade treatment is worth.
...
* The Duffy Square plaza furniture is missing: no cafe tables and chairs, no planters, no Father Duffy statue, no granite bollards. The plaza polygons are there but they are bare grey.
* The tile shells are flat pastel solids with windows cut as small unglazed dashes; there is no glass, no mullion, no spandrel and no cornice shadow on any of them.
...
* The photograph was taken in late May with the trees in full leaf; the render's leaf-off decision is right for the date it was given but makes the two foregrounds differ further.
...
| no people | no crowd or character placement feeds the verification scene | data |
...
| flat shells, unglazed window dashes | shells carry a per-material base colour; the facade kit supplies openings but no glass, mullions or sign faces | material |
