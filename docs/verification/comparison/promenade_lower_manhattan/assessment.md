...
Re-rendered against the corrected `b_wtc_site` model — the World Trade Center site stood 3.5 m too high, its plaza was an unbroken 520 x 520 m quad over both memorial pools, and its 220 oaks each carried a merged impostor card (`docs/verification/landmarks/REPORT_B.md` §12). **0.043 % of pixels differ by more than 8/255, maximum 43**, and frame mean and standard deviation are unchanged (0.701 / 0.151). Two causes, both small at this range: the World Trade Center's 3.5 m drop subtends 0.093 deg at 2,148 m, about 1.7 px; and the scene imported 89 building tiles against 76, **15** of them now carrying `tile_buildings_nj.glb`, which the New Jersey stage produced after this sheet was first rendered — it thickens the haze band behind the Battery cluster and changes nothing the verdict rests on. Nothing in this assessment changes.
