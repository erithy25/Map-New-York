...
**Camera** — 40.77350, -73.97110 (NYC_TM -1778, 8174) at z 24.2 m NAVD88 | azimuth 13.9°, pitch -1.9° | 28 mm on 36 mm (65.5° horizontal) | 1280x854. The camera stands on **the item's recorded viewpoint**, and it stands on the **roof of `lm_b_bethesda_terrace.26`**, then walked 12 m along the view azimuth to what the clearance rule takes for the parapet.

**Sun** — azimuth 92.9°, elevation 20.3° at 2026-04-18T08:04:45−04:00, from the photograph's own EXIF timestamp; 657.2 W/m² direct normal, Filmic, +1.10 stops. This is the one thing on the sheet that is exactly the photograph's.

**In the scene** — 4/4 building tiles (231,192 tris), 8 landmark models of which 6 can fall inside the 65.5° frame, 14,791 pavement polygons over 742.7 m, 224 props of the 258 in range, 100 kit pieces, 0 vehicles and 11 people; 1,697,014 triangles. Ground mesh 86,028 triangles, 0 holes.
...
* **The frame is still too bright and much too pale, and both numbers moved the right way when the lighting was fixed.** Measured off both halves of the sheet (`frame_stats.json`, written by `tools/frame_stats.py`): mean luminance **0.5359** against the photograph's **0.391** — **1.371×**. Both figures moved toward the photograph when the sun-to-sky ratio was corrected; the before-and-after readings are in docs/DEVIATIONS.md J67 rather than here, because an assessment should describe the sheet it sits beside. Mean chroma **0.0604** against **0.1435**, a ratio of **0.421**. The tonal spread is the part still clearly wrong: sd **0.1195** against **0.2089**, and the render's 5th percentile is **0.3269** where the photograph's is **0.0933** — there is still nothing dark in this frame, and a picture with the Ramble in it has deep shadow all through it. The exposure is part of it: **+1.10 stops** are opened for a 20.3° Sun, over a frame filled by a pale concrete deck with no canopy over it.
...
* **11 props in range were not placed** and 3 opaque impostor cards were dropped; 34 more props are in range than were placed. **34 point props have no asset at all**: 11 artworks, 9 drinking fountains, 5 memorials, 6 parks buildings and 3 comfort stations. Two of those categories matter here specifically — the Angel of the Waters is an *artwork* and this sheet is a picture of it.
...
| frame mean 0.5359 against 0.391 | +1.10 stops opened for a 20.3° sun, over a frame filled by a pale concrete deck | verification |
| chroma 0.0604 against 0.1435, and a 5th percentile of 0.3269 against 0.0933 | no foliage, no water and no brick paving in the frame; what is in it is concrete and asphalt | verification |
