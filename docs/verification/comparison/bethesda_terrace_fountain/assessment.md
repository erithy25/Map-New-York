...
| frame mean 0.7329 against 0.391 | +1.10 stops opened for a 20.3° sun, over a frame filled by a pale concrete deck | verification |
| chroma 0.0644 against 0.1435, and a 5th percentile of 0.5113 against 0.0933 | no foliage, no water and no brick paving in the frame; what is in it is concrete and asphalt | verification |
