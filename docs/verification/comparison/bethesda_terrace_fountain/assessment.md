...
* The Lake cannot be picked out of the picture. The caption counts 3,737 quads on the flattened water surface and B16 records that the balustrade hides all but 455 pixels of it; nothing in the frame reads as water, where the photograph's upper third is green water.
...
* Three faults on the sheet's own caption strip. "7 landmarks" under **In frame** counts landmarks placed in the scene: The Dakota is one of the seven and stands on Central Park West, outside a 65.5 deg frame aimed at 14.2 deg. The subject is "27 m from the camera" on one line and "69 m away" on the next. And the pavement breakdown lists six kinds summing to 966 of the 969 it reports, dropping the 3 plaza polygons.
