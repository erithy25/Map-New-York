...
**`sightline.subject_visible` is `false`.** Of the five rays cast at Bethesda Fountain, **one** lands on it; the line of sight is closed at **14.7 m** by `lm_b_bethesda_terrace.20` — a piece of the terrace the camera is standing on. The fan is the **12 m floor** and the record says so: the subject measures 8.6 m, under the floor, so the fan is not sized to it (J76). Widening it would not help — what closes the line is a wall, not a lamp standard. The frame shows a concrete deck, a roadway with a yellow centre line, a long wall and a distant skyline. The photograph shows the Angel of the Waters, the fountain basin, the Lake and the Ramble. **These are not two views of one place; they are two places.** Nothing below should be read as a comparison of Bethesda Terrace, because no part of Bethesda Terrace as a viewer would recognise it is in this frame.
...
* **The subject's height is measured here rather than looked up, and the two disagree.** 17 of 17 rays land on built fabric at the fountain's coordinate and the highest is `lm_b_bethesda_terrace.2` at **8.64 m** above the ground there. The catalogue's `b_bethesda_terrace` origin stands **0.1 m** away and publishes **7.92 m** — so even in the case the old rule handled correctly, the number it supplied was the model's *published* height and not the height of what stands at the point. The axis moved from −1.9° to **−1.7°** on the difference (J74).
...
* **The frame is too bright and much too pale.** Mean luminance **0.5356** against the photograph's **0.3910** — **1.37×**. Mean chroma **0.061** against **0.1435**, a ratio of **0.425**. The tonal spread is the part most clearly wrong: standard deviation **0.1195** against **0.2089** (a ratio of **0.572**), and the render's 5th percentile is **0.3269** where the photograph's is **0.0933** — there is nothing dark in this frame, and a picture with the Ramble in it has deep shadow all through it. The exposure is part of it: **+1.10 stops** are opened for a 20.3° Sun, over a frame filled by a pale concrete deck with no canopy over it.
...
| frame mean 1.37× the photograph | +1.10 stops opened for a 20.3° sun, over a frame filled by a pale concrete deck | verification |
| chroma 0.425× and a 5th percentile of 0.3269 against 0.0933 | no foliage, no water and no brick paving in the frame; what is in it is concrete and asphalt, and the camera is aimed over a parapet at neither the Lake nor the Ramble | verification |
...
*Re-read against the v15 render of 2026-09-08T21:34:54Z. The picture is unchanged in substance — a pale concrete deck, a parapet, a roadway with a yellow centre line and a distant skyline, and no fountain, no Lake and no Ramble. What changed is that the subject's height is now measured off the geometry standing at its coordinate rather than taken from the catalogue, which moved the axis by 0.2°, and that the sheet's statistics are measured by the render that made it (J74, J76, J77).*
