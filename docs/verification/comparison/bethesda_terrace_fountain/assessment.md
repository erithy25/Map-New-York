...
**And the Angel of the Waters is not in the render.** The height probe casts **43 rays, all 43 landing on built fabric**, and measures the subject at **8.64 m** above a ground of 17.16 m. The object it measured is `lm_b_bethesda_terrace.2`, a thin upright slab. The sightline then casts 13 rays, **13 clear**, **7 of them on the subject**, for a visible fraction of **0.538**, and reports `subject_visible: true`. Every one of those numbers is correct, and together they certify that a stepped base carrying a slab is visible where the photograph shows a tiered bronze fountain with a winged figure on top. **The verification passed on a stand-in.** The record is not lying; it is measuring the thing that is there.

**And this is the sheet where J113's repair overshoots.** The fan's across-extent used to be that slab's own 3.3 m, which was far too narrow — the fault J113 records. It is now the plan extent of **all 27 parts of `lm_b_bethesda_terrace`**, which is **104.4 m across this camera's bearing of 20.4°** out of an axis-aligned 131.4 by 102.5 m, and at 51 m that subtends more than the picture: the half-angle comes out at **32.74°** and is **clipped to the frame** at exactly the lens's own 32.74°. So the fan is now the whole photograph. The fraction of **0.538** is a measure of how much of the *frame* the terrace occupies, not of whether the fountain is visible in it. Neither extent is the subject's: the fountain is a 3.3 m object standing inside a **153.6 m** landmark model that carries its own site. J113 is amended with this third case — a part is too narrow, the model is too wide, and a landmark whose model includes the ground around it needs the subject's own footprint rather than either.
...
* **The fountain is massing, not sculpture.** No winged figure, no tiered bowls, no bronze: a stepped cylinder with a short upright block on it, in flat pink-grey. The photograph's subject is the most detailed object in its frame and the render's is among its least.
