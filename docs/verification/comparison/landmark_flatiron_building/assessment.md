...
* **The massing and the orientation.** A wedge with its prow to the camera and a flank falling away on each side, a rounded prow, a dentil cornice at the head of both flanks, a rusticated base of about five storeys and a pale shaft above — in both halves, at the same place in the frame.
