...
* **The city is populated now, and this frame is the case for reading these counts carefully.** 89 vehicles and 281 pedestrians from one frame of the running simulation are in the scene — 49 sedans, 18 SUVs, 5 taxis, 4 MTA buses, 3 box trucks, 3 vans, 2 boro taxis, 5 black cars. Of those, 35 vehicles and 69 pedestrians fall inside this camera's own 54.4° frame, and **about two vehicles and four people are actually visible** — the nearest vehicle is 92 m away and the rest stand behind the block faces, because a 54.4° wedge at 200 m is 206 m wide and most of that width is inside the blocks rather than on the street. Nothing is wrong with the placement; the caption's "89 vehicles" is a disc count and not a frame count, and a reader should not take it for one.
