...
**In the scene**, within 720.0 m of the camera and not all of it in frame — 4 building tiles (212,356 tris), 0 landmark models, 21,221 pavement polygons (7,333 white, 4,286 sidewalk, 4,237 roadbed, 3,062 curb, 858 parking lot, 622 yellow, 446 crosswalk, 376 median, 1 plaza), 2941 props of the 3,021 in range, 2,445 kit pieces, 73 vehicles and 265 people; 2,585,723 triangles. Ground mesh 88,200 triangles, 0 holes. 15 city surfaces are dressed from the shared photographic catalogue.
...
| p95 0.6483 against 0.8745 | sky and sunlit wall fill half the photograph; pavement and one stucco face are the render's brightest | reference |
