...
| NYC 1-ft DEM (26.6 GB zip) | Too large for disk | Terrain is built from USGS 3DEP 1/9 arc-second (~3.4 m) LiDAR-derived DEM, densified with 1.08 M building ground elevations (LiDAR) and NYC planimetric spot elevations (survey grade). Effective horizontal resolution 2 m, vertical ≈ 0.15 m. |
