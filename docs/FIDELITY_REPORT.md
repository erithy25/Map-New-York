...
Generated 2026-09-07 10:04 UTC from commit `b5f7c452db02` by `pipeline/nycsim_pipeline/report/fidelity.py`.
...
That is **81 deviations**, each with the stage report it is drawn from. The source document is `docs/DEVIATIONS.md`.
