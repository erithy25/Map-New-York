...
Generated 2026-09-07 06:45 UTC from commit `a761f356267f` by `pipeline/nycsim_pipeline/report/fidelity.py`.
...
That is **78 deviations**, each with the stage report it is drawn from. The source document is `docs/DEVIATIONS.md`.
