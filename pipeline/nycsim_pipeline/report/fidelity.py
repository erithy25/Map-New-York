...
def build_report() -> str:
    ...
    A("2. **The spandrel band at each floor line** (B12), the half of the shell material pass that a glTF "
      ...
      "class average.")
    A("3. **Let the comparison camera tilt** (I18). Twelve of the twenty landmark sheets that can be "
      "matched to their own catalogue entry cannot contain their subject: the Chrysler Building at "
      "72 m needs 77.1° of elevation and its frame reaches 36.9°, so that sheet shows an anonymous "
      "Midtown street. Nothing is wrong with the world in those frames — every element is correctly "
      "placed — and three individually sensible rules compose to produce it: a level optical axis for "
      "proportional comparability, an 18 mm lens floor against distortion, and an aspect ratio taken "
      "from the reference photograph. The fix is what a photographer does: tilt up, accept the "
      "converging verticals, record the tilt in `render.json` and say on the sheet why. It is listed "
      "this high not because it is the largest gap but because it is the most *visible* one — a "
      "reader meets \"the Chrysler Building sheet does not show the Chrysler Building\" before "
      "anything else in this report. None of the seven mandated viewpoints is affected.")
    ...
    A("7. **A structures stage for what is neither building, road, nor prop** (B13), and its input is "
      ...
      "disk.")
    A("8. **Write `roofs.glb`, or drop the column and amend the contract** (B6). "
    ...
    A("9. **A canopy for the parks** (D10). 49,175 OpenStreetMap trees now stand where there were "
    ...
    A("10. **Footprint reconciliation for the New Jersey towers** (B11a). The OSM ingest shipped and moved "
