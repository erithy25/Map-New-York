...
CATALOGUE: list[Item] = [
    ...
    _it("landmark_central_park_sheep_meadow", "Central Park: Sheep Meadow with the Midtown skyline", "landmark",
        ...
        gps_subject_max_m=1500, min_year=2016, exclude=AERIAL_WORDS + ["night", "snow", "concert"]),
    ...
    _it("landmark_111_west_57th", "111 West 57th Street (Steinway Tower, Billionaires' Row)", "landmark",
        ...
        [["111 west 57th", "111 w 57th", "steinway tower", "steinway building"]],
        ...
        exclude=AERIAL_WORDS + ["night", "interior", "rendering", "steinway hall interior"]),
    ...
    _lmk("landmark_central_park_wall_gates", "Central Park perimeter wall and gates",
         ['Central Park entrance gate Manhattan', 'Central Park perimeter wall Fifth Avenue'],
         [["central park"], ["perimeter wall", "park wall", "stone wall", "scholars' gate", "merchants' gate", "artists' gate", "gate", "gates", "gateway", "entrance", "fence", "railing"]],
    ...
    _lmk("landmark_30_hudson_yards", "30 Hudson Yards",
         ...
         exclude=AERIAL_WORDS + ["rendering", "interior", "from the edge", "view from"]),
    _lmk("landmark_35_hudson_yards", "35 Hudson Yards",
         ...
         geosearch_radius_m=400, gps_subject_max_m=4000, min_year=2019,
         exclude=AERIAL_WORDS + ["rendering", "interior"]),
    ...
    _lmk("landmark_55_hudson_yards", "55 Hudson Yards",
         ['55 Hudson Yards Manhattan', '55 Hudson Yards tower'],
    ...
    _lmk("landmark_15_hudson_yards", "15 Hudson Yards",
         ['15 Hudson Yards', '15 Hudson Yards Manhattan tower'],
    ...
    _lmk("landmark_50_hudson_yards", "50 Hudson Yards",
         ['50 Hudson Yards Manhattan', '50 Hudson Yards tower'],
    ...
    _lmk("landmark_the_shed", "The Shed",
         ...
         exclude=AERIAL_WORDS + ["rendering", "interior", "performance"]),
    ...
    _lmk("landmark_tsx_broadway", "TSX Broadway",
         ['TSX Broadway Times Square', 'TSX Broadway Palace Theatre 1568 Broadway'],
         [["tsx broadway", "tsx", "1568 broadway"], ["times square", "broadway"]], (40.759, -73.984523), 200.0, 130.0,
         ...
         exclude=AERIAL_WORDS + ["under construction", "crane", "rendering", "interior", "new year", "ball drop", "construction"]),
    ...
    _lmk("landmark_citigroup_center", "Citigroup Center (601 Lexington Avenue)",
         ['Citigroup Center Manhattan', '601 Lexington Avenue New York'],
         [["citigroup center", "citicorp center", "citigroup", "citicorp", "601 lexington"]], (40.758611, -73.970278), 200.0, 200.0,
    ...
    _lmk("landmark_metlife_building", "MetLife Building (200 Park Avenue)",
         ...
         exclude=AERIAL_WORDS + ["interior", "helicopter crash", "1963", "1970", "stadium", "under construction", "270 park"]),
    ...
    _lmk("landmark_javits_center", "Jacob K. Javits Convention Center",
         ...
         geosearch_radius_m=500, gps_subject_max_m=3000,
         exclude=AERIAL_WORDS + ["interior", "comic con", "auto show", "hospital", "vaccination", "trade show"]),
    ...
    _it("street_elevated_broadway_bushwick_j", "Elevated subway street: Broadway (Brooklyn) under the J", "streetscape",
        ...
        exclude=["night", "platform", "mezzanine", "interior", "inside", "manhattan", "1900", "1910", "1920", "bookstore", "book row"],
        allow=("bmt", "irt", "subway station", "subway entrance", "subway platform", "station platform", "mezzanine", "staircase")),
    _it("street_midtown_avenue_rush_hour", "Midtown avenue at rush hour", "streetscape",
        ['Midtown Manhattan avenue traffic taxi', 'Manhattan avenue traffic rush hour taxis', 'Midtown Manhattan street traffic pedestrians avenue'],
        [["manhattan", "midtown"], ["traffic", "rush hour", "taxi", "taxis", "cab", "cabs", "crowd", "pedestrians", "avenue", "street"]],
        ...
        exclude=AERIAL_WORDS + ["night", "1970", "1980", "1990", "protest", "parade", "marathon", "snow", "high line",
    ...
    _it("street_nyc_street_name_signs", "NYC street name signs (close-ups)", "streetscape",
        ['New York City street name sign', 'Manhattan street corner sign post', 'street signs New York City intersection'],
