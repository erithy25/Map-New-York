...
// trucks (a=0.7, b=1.5, T=1.7, s0=2.5), with two deliberate departures for a
// city street, both documented in REPORT.md Calibration:
//   * passenger-car acceleration is raised to 1.7-2.0 m/s2.  Table 11.2 is a
//     motorway car-following calibration; measured queue-discharge acceleration
//     at urban signals is 1.5-2.0 m/s2, and it is what sets saturation flow.
//   * the car time headway is 1.0 s (the low end of the published range), which
//     with s0 = 2 m and a 4.885 m body reproduces the HCM saturation headway of
//     about 1.9 s at capacity.
...
const VehicleClassParams kTable[kVehicleClassCount] = {
  ...
  { "sedan",          "Toyota Camry XV70",          4.885f, 1.840f, 1.445f, 1.8f, 2.0f, 8.0f, 1.0f, 2.0f, 1.10f, mph(75.f),  0.20f, 3.0f, 0.50f, 0.98f, 0.0f, kMotorLaneKinds,     true,  false, false, false, false, false },
  { "taxi",           "Toyota Camry Hybrid (yellow medallion)", 4.885f, 1.840f, 1.445f, 2.0f, 2.5f, 8.0f, 0.9f, 1.5f, 1.15f, mph(75.f), 0.10f, 2.2f, 0.90f, 0.97f, 0.6f, kMotorLaneKinds, true, false, false, false, false, true },
  { "boro_taxi",      "Toyota RAV4 Hybrid (green SHL)", 4.600f, 1.855f, 1.685f, 1.9f, 2.3f, 8.0f, 1.0f, 1.5f, 1.12f, mph(75.f), 0.12f, 2.4f, 0.85f, 0.97f, 0.5f, kMotorLaneKinds, true, false, false, false, false, true },
  { "black_car",      "Chevrolet Suburban",         5.733f, 2.057f, 1.927f, 1.8f, 2.0f, 7.5f, 1.1f, 2.0f, 1.10f, mph(75.f),  0.18f, 3.2f, 0.60f, 0.98f, 0.8f, kMotorLaneKinds,     true,  false, false, false, false, false },
  { "suv",            "Toyota RAV4 Hybrid",         4.600f, 1.855f, 1.685f, 1.7f, 2.0f, 8.0f, 1.1f, 2.0f, 1.08f, mph(75.f),  0.22f, 3.2f, 0.50f, 0.98f, 0.0f, kMotorLaneKinds,     true,  false, false, false, false, false },
  ...
  { "van",            "Mercedes-Benz Sprinter 144\"", 5.932f, 2.020f, 2.438f, 1.5f, 1.8f, 7.0f, 1.3f, 2.0f, 1.05f, mph(70.f), 0.25f, 3.2f, 0.70f, 0.97f, 3.0f, kMotorLaneKinds,    true,  false, false, false, true,  false },
