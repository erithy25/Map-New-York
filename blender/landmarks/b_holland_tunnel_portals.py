...
def main() -> None:
    ...
    ba.run_landmark(
        ...
        renders=[
            ...
            ba.reference_render("landmark_holland_tunnel_portal", frame, view="manhattan_portal_reference",
            ...
            dict(view="tube_interior", cam=tuple(cam_in), target=tuple(tgt_in),
                 fov_deg=72.0, sun_elevation_deg=88.0, sun_strength=0.02, sky_strength=0.0, exposure=2.4, max_bounces=2, size=(960, 540)),
