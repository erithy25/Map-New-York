...
WARDROBE: tuple[Garment, ...] = (
    # ---- tops (base layer)
    Garment("tee_white", "White crew tee", "top", TORSO + UPPERARM, 0.44, 0.83, 0.007, 0.0035,
            _c("e8e6e1"), 0.82, tags=("tee",)),
    Garment("tee_black", "Black crew tee", "top", TORSO + UPPERARM, 0.44, 0.83, 0.007, 0.0035,
            _c("1b1b1d"), 0.85, tags=("tee",)),
    Garment("tee_tourist", "I-heart-NY tourist tee", "top", TORSO + UPPERARM, 0.43, 0.83, 0.008, 0.0035,
            _c("f2f2ee"), 0.86, tags=("tee", "tourist")),
    Garment("tee_yankees", "Navy team tee", "top", TORSO + UPPERARM, 0.44, 0.83, 0.007, 0.0035,
            _c("162a4c"), 0.84, tags=("tee",)),
    Garment("polo_grey", "Grey polo", "top", TORSO + UPPERARM, 0.44, 0.85, 0.008, 0.004,
            _c("6c6f74"), 0.78, tags=("polo",)),
    Garment("shirt_oxford", "Blue oxford shirt", "top", TORSO + UPPERARM + FOREARM, 0.43, 0.86, 0.010, 0.004,
            _c("9db6cf"), 0.68, tags=("shirt", "office")),
    Garment("shirt_flannel", "Red flannel shirt", "top", TORSO + UPPERARM + FOREARM, 0.41, 0.86, 0.012, 0.005,
            _c("7d2b26"), 0.83, tags=("shirt",)),
    Garment("sweater_knit", "Charcoal knit sweater", "top", TORSO + UPPERARM + FOREARM, 0.43, 0.87, 0.014,
            0.006, _c("3a3d42"), 0.88, tags=("knit",)),
    Garment("scrubs_top", "Hospital scrubs top", "top", TORSO + UPPERARM, 0.42, 0.85, 0.011, 0.004,
            _c("2f6f6a"), 0.80, tags=("scrubs", "work")),
    Garment("blouse_cream", "Cream blouse", "top", TORSO + UPPERARM, 0.44, 0.86, 0.009, 0.0035,
            _c("efe6d6"), 0.62, tags=("office",)),
    Garment("tank_grey", "Grey tank top", "top", TORSO, 0.44, 0.82, 0.006, 0.003,
            _c("9a9a96"), 0.85, tags=("summer",)),
    Garment("kids_tee_stripe", "Kid's striped tee", "top", TORSO + UPPERARM, 0.42, 0.84, 0.007, 0.0035,
    ...
    # ---- bottoms
    Garment("jeans_indigo", "Indigo jeans", "bottom", HIPS + THIGHS + CALVES, 0.055, 0.55, 0.011, 0.005,
            _c("2f4260"), 0.80, tags=("jeans",)),
    Garment("jeans_black", "Black jeans", "bottom", HIPS + THIGHS + CALVES, 0.055, 0.55, 0.011, 0.005,
            _c("1c1c1e"), 0.82, tags=("jeans",)),
    Garment("chinos_khaki", "Khaki chinos", "bottom", HIPS + THIGHS + CALVES, 0.055, 0.55, 0.011, 0.005,
            _c("9c8a68"), 0.80, tags=("chinos",)),
    Garment("suit_trousers", "Charcoal suit trousers", "bottom", HIPS + THIGHS + CALVES, 0.05, 0.55, 0.012,
            0.005, _c("35373c"), 0.70, tags=("suit", "office")),
    Garment("scrubs_pants", "Hospital scrubs trousers", "bottom", HIPS + THIGHS + CALVES, 0.06, 0.55,
            0.014, 0.005, _c("2f6f6a"), 0.80, tags=("scrubs", "work")),
    Garment("joggers_grey", "Grey joggers", "bottom", HIPS + THIGHS + CALVES, 0.07, 0.55, 0.013, 0.005,
            _c("6a6c70"), 0.86, tags=("athleisure",)),
    Garment("skirt_pencil", "Black pencil skirt", "bottom", HIPS + THIGHS, 0.30, 0.55, 0.012, 0.005,
            _c("1e1e20"), 0.72, tags=("office",)),
    Garment("kids_jeans", "Kid's jeans", "bottom", HIPS + THIGHS + CALVES, 0.05, 0.55, 0.010, 0.0045,
