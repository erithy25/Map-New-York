...
# --------------------------------------------------------------------------- 1  plain 1/1
@K.register("win_double_hung_1_1", "window", nominal_size=(0.95, 0.29, 1.70),
...
@K.register("win_double_hung_1_1_stone", "window", nominal_size=(1.18, 0.34, 1.95),
...
@K.register("win_double_hung_1_1_soldier", "window", nominal_size=(1.10, 0.29, 1.99),
...
# --------------------------------------------------------------------------- 4  2/2
@K.register("win_double_hung_2_2", "window", nominal_size=(1.18, 0.34, 2.05),
...
# --------------------------------------------------------------------------- 5  6/6
@K.register("win_double_hung_6_6", "window", nominal_size=(1.13, 0.34, 1.85),
...
# --------------------------------------------------------------------------- 6  casement pair
@K.register("win_casement_pair", "window", nominal_size=(1.33, 0.34, 1.85),
...
# --------------------------------------------------------------------------- 7  steel industrial
@K.register("win_steel_industrial_4x5", "window", nominal_size=(1.66, 0.30, 2.44),
...
# --------------------------------------------------------------------------- 8  punched office
@K.register("win_punched_office", "window", nominal_size=(1.68, 0.32, 2.42),
...
@K.register("win_curtain_wall_module", "window", nominal_size=(1.50, 0.26, 3.90), anchor="wall_bottom_centre",
...
# --------------------------------------------------------------------------- 11  arched tenement
@K.register("win_arched_tenement", "window", nominal_size=(1.10, 0.29, 2.29),
...
# --------------------------------------------------------------------------- 12  dormer
@K.register("win_dormer", "window", nominal_size=(1.46, 1.42, 1.98), anchor="wall_bottom_centre",
...
# --------------------------------------------------------------------------- 13  aluminium slider
@K.register("win_aluminum_slider", "window", nominal_size=(1.31, 0.29, 1.55),
...
# --------------------------------------------------------------------------- 14  picture window
@K.register("win_picture_window", "window", nominal_size=(2.02, 0.29, 1.61),
...
# --------------------------------------------------------------------------- 16  ribbon strip
@K.register("win_ribbon_strip", "window", nominal_size=(3.00, 0.28, 1.62),
...
@K.register("win_chicago_tripartite", "window", nominal_size=(2.63, 0.34, 2.55),
...
@K.register("win_through_wall_ac_sleeve", "window", nominal_size=(0.80, 0.29, 0.56),
